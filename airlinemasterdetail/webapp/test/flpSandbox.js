		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#appsdflcairlinemasterdetail-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"appsdflcairlinemasterdetail-display": {
								"semanticObject": "appsdflcairlinemasterdetail",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=apps.dflc.airlinemasterdetail",
									"url": sap.ui.require.toUrl("apps/dflc/airlinemasterdetail")
								}
							}
						}
					}
