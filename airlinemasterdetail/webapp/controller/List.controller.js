sap.ui.define([
    ...
    return BaseController.extend("apps.dflc.airlinemasterdetail.controller.List", {
        ...
        onSearch: function (oEvent) {
            ...
            if (sQuery) {
                this._oListFilterState.aSearch = [new Filter("AirlineName", FilterOperator.Contains, sQuery)];
            } else {
