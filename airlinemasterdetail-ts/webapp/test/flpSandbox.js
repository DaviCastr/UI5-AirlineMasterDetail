		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Airline Master Detail",
									"targetURL": "#appsdflcairlinemasterdetailts-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"appsdflcairlinemasterdetailts-display": {
								"semanticObject": "appsdflcairlinemasterdetailts",
								"action": "display",
								"description": "Airline Master Detail",
								"title": "Airline Master Detail",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=apps.dflc.airlinemasterdetailts",
									"url": sap.ui.require.toUrl("apps/dflc/airlinemasterdetailts")
								}
							}
						}
					}
