...
export default class Detail extends BaseController {
     ...
     */
     private onObjectMatched(event: Event) {
        ...
        this.getModel<ODataModel>().metadataLoaded().then(function (this: Detail) {
            const objectPath = this.getModel<ODataModel>().createKey("AirlineSet", {
                AirlineID: AirlineID
            });
    ...
    private onBindingChange() {
        ...
        viewModel.setProperty("/shareSendEmailSubject",
            resourceBundle.getText("shareSendEmailObjectSubject", [detailObject.AirlineID]));
        viewModel.setProperty("/shareSendEmailMessage",
            resourceBundle.getText("shareSendEmailObjectMessage", [detailObject.AirlineName, detailObject.AirlineID, location.href]));
    }
